...
export const YoungAdultSlideshow = forwardRef<YoungAdultSlideshowRef, YoungAdultSlideshowProps>(({ onBookChange, isWidescreen = false }, ref) => {
  ...
  // Non-widescreen (iPad, etc.): Use original proportional sizing
  const containerClasses = isWidescreen
    ...
    : "relative w-full bg-black/60 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg border border-white/20 min-h-[500px]";
  ...
  // Non-widescreen (iPad, etc.): Use original proportional max-width sizing
  const imageClasses = isWidescreen
    ...
    : "w-full max-w-sm mx-auto object-contain rounded-lg shadow-lg transition-opacity duration-100 max-sm:max-w-[200px]";
