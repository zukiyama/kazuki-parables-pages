    ...
    return (
      <div className={`relative ${className}`}>
        <img 
          ...
          className="w-full max-w-sm mx-auto object-contain shadow-2xl"
          loading={loading}
        />
      </div>
    );
  ...
  return (
    <div className={`relative ${className}`}>
      <img 
        ...
        className="w-full max-w-sm mx-auto object-contain shadow-2xl transition-opacity duration-300"
        loading={loading}
      />
