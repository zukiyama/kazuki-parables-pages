  ...
  return (
    <div className="py-2 bg-black/80 backdrop-blur-sm">
      <div className="container mx-auto px-6">
        <div className="flex justify-end items-center py-6 pb-2 relative min-h-[140px]">
          {/* Items Container - Absolutely centered relative to full banner width */}
          <div className="absolute left-1/2 -translate-x-1/2 top-2 flex justify-center items-center gap-8 overflow-visible">
            <div
              ref={containerRef}
