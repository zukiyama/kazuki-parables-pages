              ...
              <div className="hidden lg:block xl:hidden">
                ...
                <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="col-span-7 flex flex-col">
                    <h1 className="font-heading text-8xl text-black leading-[0.85] tracking-tight mb-3">
                      Kazuki
                      <br />
                      <span className="italic font-light">Yamakawa</span>
                    </h1>
                    
                    <p className="font-body text-lg text-black leading-snug mb-4 border-l-4 border-black/20 pl-4">
                      A multi-disciplinary artist working in literature, music and visual storytelling.
                    </p>
