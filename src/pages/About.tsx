            ...
            <div className="lg:col-span-2 flex items-center relative z-10 lg:pl-8">
              <div className="space-y-6">
                ...
                <p className="font-body text-base lg:text-lg leading-relaxed text-foreground/80 max-w-2xl">
                  Kazuki Yamakawa is a multi-disciplinary artist working in literature, music and visual storytelling. He has lived in various countries but calls England home. Kazuki Yamakawa is a multi-disciplinary artist working in literature, music and visual storytelling. He has lived in various countries but calls England home. A writer in the games industry in a previous life, he decided in his thirties to pursue the work that has been his lifelong vocation. Combining metaphysics with an unusual levity and invention, his literary works explore what it is to be real while remaining, above all things, deeply human. The best way to get to know his music is to head over to the music page where samples are available as well as links to Spotify/Bandcamp et al. Combining metaphysics with an unusual levity and invention, his literary works explore what it is to be real while remaining, above all things, deeply human. The best way to get to know his music is to head over to the music page where samples are available as well as links to Spotify/Bandcamp et al.
                </p>
              </div>
            </div>
          </div>
