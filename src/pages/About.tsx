      ...
      <div className="container mx-auto px-6 py-16 max-w-6xl">
        ...
        <div className="relative -mx-6 mb-3">
          ...
          <div className="relative pointer-events-none overflow-hidden" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', paddingLeft: '0.75rem', paddingRight: '0.75rem' }}>
            ...
            <div className="absolute top-[15%] left-[8%] max-w-md pointer-events-auto hidden md:block">
            ...
            <div className="md:hidden absolute top-4 left-4 right-4 pointer-events-auto">
        ...
        <div className="relative mb-[30px] -mx-6">
          <div className="flex gap-[14px] max-md:gap-2 max-md:flex-col justify-between" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', paddingLeft: '0.75rem', paddingRight: '0.75rem' }}>
            <div className="flex-1 aspect-[4/3] max-md:aspect-[16/9] overflow-hidden">
              <OptimizedImage 
