                  ...
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-slate-900/90 via-cyan-950/80 to-slate-900/90 p-6 rounded border border-cyan-400/40" style={{
                      ...
                      <p className="font-sans text-base leading-relaxed text-cyan-100/90 mb-3">
                        James Tarreden's new life on Island—the world's first corporate nation-state—seems to be off without a hitch. Zero crime, colleagues who like him—even his love life is going disconcertingly well. In fact, everything is falling into place a little too easily…
                      </p>
                      <p className="font-sans text-base leading-relaxed text-cyan-100/90 mb-3">
                        Under the wing of a charismatic young CEO, James is inducted into the secrets behind his company's new technology, and with everything he knew about reality unravelling, finds himself in an increasingly high-stakes game of cat and mouse to discover the truth of Island, one that gives an entirely new meaning to corporate survival.
                      </p>
