              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className={`transition-all duration-1000 delay-500 ${
                  ...
                  <div className="bg-gray-500/60 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                    <h2 className="font-new-york text-5xl font-bold mb-4 text-white">
                      KAIJU
                    </h2>
                    <h3 className="font-new-york text-xl text-yellow-300 mb-4 tracking-wide">
                      Book One of The Parable Trilogy
                    </h3>
                    <p className="font-new-york text-lg leading-relaxed text-white">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                {/* Title above the memo */}
                  <h2 className="font-new-york text-5xl font-bold mb-6 text-white tracking-wide drop-shadow-lg">
                    HOAX
                  </h2>
                  ...
                  <div className="relative">
                    ...
                    <div className="p-8 shadow-lg" style={{
                      ...
                      <p className="font-new-york text-base leading-loose text-stone-600" style={{ lineHeight: '1.9' }}>
