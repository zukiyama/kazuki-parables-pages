...
// Vignette images moved to VignetteOverlay component
...
const Writing = () => {
  ...
  const otherWorksSectionRef = useRef<HTMLElement>(null);
  ...
  return (
    ...
    >
      ...
      <main ref={mainRef} className={`relative z-10 transition-all duration-500 ${
        ...
        >
          {/* Vignette Overlay - renders via portal, fixed to viewport */}
          <VignetteOverlay 
            activeVignette={activeVignette} 
            sectionRef={otherWorksSectionRef} 
          />
                ...
                <article className="text-center">
                  ...
                  >
                    <p className={`font-serif text-sm leading-relaxed max-w-md mx-auto transition-colors duration-700 ${otherWorksWhiteMode ? 'text-neutral-600' : 'text-neutral-400'}`}>
                      An anthology—two boys in diving helmets wandering the dunes; a holiday where people go to war; an actor who becomes convinced that the character he's playing is real; and an oncoming invasion in which the only defence is a set of blueprints left by the previously defeated—these and other stories play with reason and bend perception.
                    </p>
                  </div>
                </article>
