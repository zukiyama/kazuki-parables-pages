        ...
        <section data-section="kaiju" className={`flex items-center justify-center relative ${
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="max-w-6xl mx-auto">
              ...
              {/* Widescreen: large padding (mb-40), non-widescreen: smaller padding */}
              <div className={`text-center sm:mt-[-4px] transition-all duration-1000 delay-300 ${
                isWidescreen ? 'mb-40' : 'mb-10 lg:mb-4'
              } ${
