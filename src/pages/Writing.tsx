        ...
        <section data-section="kaiju" className={`flex items-center justify-center relative ${
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="max-w-6xl mx-auto">
              ...
              {/* iPad desktop: less padding (mb-4), Widescreen: more padding (mb-32), iPad portrait mobile: more padding (sm:mb-10), reduce top margin on iPad portrait (sm:mt-[-8px]) */}
              <div className={`text-center max-sm:mb-10 sm:mb-10 sm:mt-[-4px] transition-all duration-1000 delay-300 ${
                isWidescreen ? 'mb-32' : 'lg:mb-4'
              } ${
