      ...
      <section className="min-h-screen relative bg-background">
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <ScrollFadeUp id="music-banner" delay={300} className="flex justify-center mt-12">
            ...
            >
              <div className="bg-gradient-to-r from-card/90 to-card/70 backdrop-blur-sm border border-border rounded-xl p-8 max-md:p-4 flex max-md:flex-col items-center gap-8 max-md:gap-4 shadow-xl hover:shadow-2xl hover:border-primary/30 transition-all duration-300">
                <div className="relative">
                  <img 
                    src={circlesSingleCover} 
                    alt="Circles single cover"
                    className="w-24 h-24 max-md:w-20 max-md:h-20 md:w-32 md:h-32 rounded-lg object-contain shadow-lg group-hover:shadow-xl transition-shadow duration-300"
                  />
                ...
                <div className="flex-1 text-left max-md:text-center">
                  ...
                  <h4 className="font-heading text-2xl max-md:text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">
                    CIRCLES
                  </h4>
        ...
        <div className={`magazine-slide ${showMagazine ? "visible" : ""} relative`}>
          <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            {showQuote && (currentImage === 0 || currentImage === 1) && (
              <div className="absolute top-1/4 right-1/4 max-w-md max-md:left-4 max-md:right-4 max-md:top-1/4 max-md:max-w-[280px]">
                <blockquote className="literary-quote text-white/90 leading-relaxed">
                  <div className="text-2xl max-md:text-2xl sm:text-3xl md:text-5xl font-bold">'Feelings are the thoughts of the heart.'</div>
                </blockquote>
              </div>
            )}
            ...
            {showQuote && currentImage === 2 && (
              <div className="absolute top-1/3 left-1/4 max-w-md max-md:left-4 max-md:right-4 max-md:top-1/3">
                <div className={`tv-shop-text-reveal ${animateTvText ? 'visible' : ''} text-white/90 leading-relaxed`}>
                  <h2 className="font-heading text-2xl max-md:text-2xl sm:text-3xl md:text-4xl mb-2">summer 1979</h2>
                  <h3 className="font-heading text-xl max-md:text-xl sm:text-2xl md:text-3xl mb-4">Osaka Japan</h3>
                  <div className="border-t border-white/30 pt-4">
                    <h4 className="font-heading text-xl max-md:text-xl sm:text-2xl md:text-3xl font-bold mb-2">KAIJU</h4>
                  ...
                  <div className="mt-8 text-center">
                    <div className="font-mono text-xl max-md:text-xl sm:text-2xl md:text-4xl font-bold text-white animate-pulse tracking-wider">
