...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen-stable flex flex-col overflow-hidden">
      ...
      <section className="h-[calc(100vh-56px)] lg:h-[calc(var(--hero-h,100dvh)-56px)] mt-14 flex items-start pt-[25vh] max-sm:pt-[20vh] portrait:[@media(min-width:768px)_and_(max-width:850px)]:pt-[22vh] justify-center relative overflow-hidden bg-background">
        <img 
